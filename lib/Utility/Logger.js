...
class Logger {
  ...
  save(state) {
    return new Promise(resolve => {
      var file = (0, _path.join)(this.logsPath, "state.json");
  ...
  getLogsPath() {
    var logsPathBase = (0, _path.join)(this.args.getProjectPath(), "logs");

    if (!(0, _fs.existsSync)(logsPathBase)) {
      (0, _fs.mkdirSync)(logsPathBase);
    }

    var logsPath = (0, _path.join)(this.args.getProjectPath(), "logs", "content");
